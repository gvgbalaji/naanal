...
cp ./temp/mysqld.cnf  /etc/mysql/mysql.conf.d/mysqld.cnf
...
#cp /opt/naanal/kilo/favicon.ico /usr/share/openstack-dashboard/static/dashboard/img/
#cp /opt/naanal/kilo/logo-splash.png /usr/share/openstack-dashboard/static/dashboard/img/
#cp /opt/naanal/kilo/logo.png /usr/share/openstack-dashboard/static/dashboard/img/

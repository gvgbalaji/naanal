...
class AddVPNServiceAction(workflows.Action):
    ...
    class Meta(object):
        ...
        help_text = _("Create VPN Service for current network.\n\n"
...
class AddVPNService(workflows.Workflow):
    ...
    success_url = "horizon:network:vpn:index"
...
class AddIKEPolicyAction(workflows.Action):
    ...
    class Meta(object):
        ...
        permissions = ('openstack.services.network',)
        help_text = _("Create IKE Policy for current network.\n\n"
...
class AddIPSecPolicyAction(workflows.Action):
    ...
    class Meta(object):
        ...
        permissions = ('openstack.services.network',)
        help_text = _("Create IPSec Policy for current network.\n\n"
...
class AddIPSecSiteConnectionAction(workflows.Action):
    ...
    class Meta(object):
        ...
        permissions = ('openstack.services.network',)
        help_text = _("Create IPSec Site Connection for current network.\n\n"

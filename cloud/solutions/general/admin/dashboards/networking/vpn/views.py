...
from openstack_dashboard.dashboards.network.vpn \
    import forms as vpn_forms
from openstack_dashboard.dashboards.network.vpn import tables as vpn_tables
from openstack_dashboard.dashboards.network.vpn import tabs as vpn_tabs
from openstack_dashboard.dashboards.network.vpn \
...
class IndexView(tabs.TabView):
    ...
    template_name = 'network/vpn/index.html'
...
class IKEPolicyDetailsView(tabs.TabView):
    ...
    template_name = 'network/vpn/details_tabs.html'
    page_title = _("Virtual Private Network")
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:network:vpn:index')
...
class UpdateVPNServiceView(forms.ModalFormView):
    ...
    template_name = "network/vpn/update_vpnservice.html"
    context_object_name = 'vpnservice'
    submit_label = _("Save Changes")
    submit_url = "horizon:network:vpn:update_vpnservice"
    success_url = reverse_lazy("horizon:network:vpn:index")
...
class UpdateIKEPolicyView(forms.ModalFormView):
    ...
    template_name = "network/vpn/update_ikepolicy.html"
    context_object_name = 'ikepolicy'
    submit_label = _("Save Changes")
    submit_url = "horizon:network:vpn:update_ikepolicy"
    success_url = reverse_lazy("horizon:network:vpn:index")
...
class UpdateIPSecPolicyView(forms.ModalFormView):
    ...
    template_name = "network/vpn/update_ipsecpolicy.html"
    context_object_name = 'ipsecpolicy'
    submit_label = _("Save Changes")
    submit_url = "horizon:network:vpn:update_ipsecpolicy"
    success_url = reverse_lazy("horizon:network:vpn:index")
...
class UpdateIPSecSiteConnectionView(forms.ModalFormView):
    ...
    template_name = "network/vpn/update_ipsecsiteconnection.html"
    context_object_name = 'ipsecsiteconnection'
    submit_label = _("Save Changes")
    submit_url = "horizon:network:vpn:update_ipsecsiteconnection"
    success_url = reverse_lazy("horizon:network:vpn:index")

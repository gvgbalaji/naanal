...
class CreateNetwork(tables.LinkAction):
    ...
    url = "horizon:networking;basics:networks:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditNetwork(policy.PolicyTargetMixin, CheckNetworkEditable,
    ...
    url = "horizon:networking:basics:networks:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateSubnet(policy.PolicyTargetMixin, CheckNetworkEditable,
    ...
    url = "horizon:networking:basics:networks:addsubnet"
    classes = ("ajax-modal",)
    icon = "plus"
    policy_rules = (("network", "create_subnet"),)
    policy_target_attrs = (("network:network_id", "tenant_id"),)
...
def get_subnets(network):
    template_name = 'networking/basics/networks/_network_ips.html'
...
class NetworksTable(tables.DataTable):
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link='horizon:networking:basics:networks:detail')

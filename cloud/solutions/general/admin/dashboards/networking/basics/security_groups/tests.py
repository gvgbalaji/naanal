...
SG_CREATE_URL = reverse('horizon:networking.basics:'
                        'security_groups:create')

SG_VIEW_PATH = 'horizon:networking.basics:security_groups:%s'
SG_DETAIL_VIEW = SG_VIEW_PATH % 'detail'
SG_UPDATE_VIEW = SG_VIEW_PATH % 'update'
SG_ADD_RULE_VIEW = SG_VIEW_PATH % 'add_rule'

SG_TEMPLATE_PATH = 'networking.basics/security_groups/%s'

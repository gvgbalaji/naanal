...
class DeleteKeyPairs(tables.DeleteAction):
    policy_rules = (("network", "network_extension:keypairs:delete"),)
...
class ImportKeyPair(tables.LinkAction):
    ...
    url = "horizon:networking:basics:keypairs:import"
    classes = ("ajax-modal",)
    icon = "upload"
    policy_rules = (("network", "network_extension:keypairs:create"),)


class CreateKeyPair(tables.LinkAction):
    name = "create"
    verbose_name = _("Create Key Pair")
    url = "horizon:networking:basics:keypairs:create"
    classes = ("ajax-modal",)
    icon = "plus"
    policy_rules = (("network", "network_extension:keypairs:create"),)
...
class KeypairsTable(tables.DataTable):
    detail_link = "horizon:networking:basics:keypairs:detail"

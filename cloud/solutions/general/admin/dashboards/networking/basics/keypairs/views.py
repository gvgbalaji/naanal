...
from openstack_dashboard.dashboards.networking.basics.keypairs \
    import forms as network_forms


class CreateView(forms.ModalFormView):
    form_class = network_forms.CreateKeypair
    form_id = "create_keypair_form"
    modal_header = _("Create Key Pair")
    template_name = 'networking/basics/keypairs/create.html'
    submit_label = _("Create Key Pair")
    submit_url = reverse_lazy(
        "horizon:networking:basics:keypairs:create")
    success_url = 'horizon:networking:basics:keypairs:download'
...
class ImportView(forms.ModalFormView):
    form_class = network_forms.ImportKeypair
    form_id = "import_keypair_form"
    modal_header = _("Import Key Pair")
    template_name = 'networking/basics/keypairs/import.html'
    submit_label = _("Import Key Pair")
    submit_url = reverse_lazy(
        "horizon:networking:basics:keypairs:import")
...
class DetailView(views.HorizonTemplateView):
    template_name = 'networking/basics/keypairs/detail.html'
...
class DownloadView(views.HorizonTemplateView):
    template_name = 'networking/basics/keypairs/download.html'

...
INDEX_URL = reverse('horizon:networking.basics:index')


class BasicsTests(test.TestCase):
    def setUp(self):
        super(BasicsTests, self).setUp()
    ...
    def _test_index(self, ec2_enabled):
        ...
        self.assertTemplateUsed(res, 'networking.basics/index.html')
    ...
    def test_association(self):
        ...
        res = self.client.get(reverse("horizon:networking.basics:"
...
class BasicsNeutronProxyTests(BasicsTests):
    def setUp(self):
        super(BasicsNeutronProxyTests, self).setUp()

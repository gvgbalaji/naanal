...
from openstack_dashboard.dashboards.networking.firewalls \
...
class IndexView(tabs.TabView):
    ...
    template_name = 'network/firewalls/details_tabs.html'
...
class FireWallDetailTabs(tabs.TabView):
    template_name = 'networking/firewalls/details_tabs.html'
...
class UpdateRuleView(forms.ModalFormView):
    ...
    template_name = "networking/firewalls/updaterule.html"
    context_object_name = 'rule'
    modal_header = _("Edit Rule")
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:firewalls:updaterule"
    success_url = reverse_lazy("horizon:networking:firewalls:index")
...
class UpdatePolicyView(forms.ModalFormView):
    ...
    template_name = "networking/firewalls/updatepolicy.html"
    context_object_name = 'policy'
    modal_header = _("Edit Policy")
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:firewalls:updatepolicy"
    success_url = reverse_lazy("horizon:networking:firewalls:index")
...
class UpdateFirewallView(forms.ModalFormView):
    ...
    template_name = "networking/firewalls/updatefirewall.html"
    context_object_name = 'firewall'
    modal_header = _("Edit Firewall")
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:firewalls:updatefirewall"
    success_url = reverse_lazy("horizon:networking:firewalls:index")
...
class InsertRuleToPolicyView(forms.ModalFormView):
    ...
    template_name = "networking/firewalls/insert_rule_to_policy.html"
    context_object_name = 'policy'
    submit_url = "horizon:networking:firewalls:insertrule"
    submit_label = _("Save Changes")
    success_url = reverse_lazy("horizon:networking:firewalls:index")
...
class RemoveRuleFromPolicyView(forms.ModalFormView):
    ...
    template_name = "networking/firewalls/remove_rule_from_policy.html"
    context_object_name = 'policy'
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:firewalls:removerule"
    success_url = reverse_lazy("horizon:networking:firewalls:index")
...
class AddRouterToFirewallView(RouterCommonView):
    ...
    template_name = "networking/firewalls/add_router_to_firewall.html"
    submit_url = "horizon:networking:firewalls:addrouter"
...
class RemoveRouterFromFirewallView(RouterCommonView):
    ...
    template_name = "networking/firewalls/remove_router_from_firewall.html"
    submit_url = "horizon:networking:firewalls:removerouter"

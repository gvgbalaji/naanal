...
from openstack_dashboard.dashboards.networking.firewalls import tables
...
class RuleDetailsTab(tabs.Tab):
    ...
    slug = "ruledetails"
    template_name = "networking/firewalls/_rule_details.html"
    failure_url = reverse_lazy('horizon:networking:firewalls:index')
...
class PolicyDetailsTab(tabs.Tab):
    ...
    slug = "policydetails"
    template_name = "networking/firewalls/_policy_details.html"
    failure_url = reverse_lazy('horizon:networking:firewalls:index')
...
class FirewallDetailsTab(tabs.Tab):
    ...
    template_name = "networking/firewalls/_firewall_details.html"
    failure_url = reverse_lazy('horizon:networking:firewalls:index')

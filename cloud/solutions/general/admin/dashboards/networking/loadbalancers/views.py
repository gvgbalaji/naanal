...
class IndexView(tabs.TabbedTableView):
    tab_group_class = (network_tabs.LoadBalancerTabs)
...
class AddPoolView(workflows.WorkflowView):
    workflow_class = network_workflows.AddPool


class AddVipView(workflows.WorkflowView):
    workflow_class = network_workflows.AddVip
...
class AddMemberView(workflows.WorkflowView):
    workflow_class = network_workflows.AddMember


class AddMonitorView(workflows.WorkflowView):
    workflow_class = network_workflows.AddMonitor


class PoolDetailsView(tabs.TabView):
    tab_group_class = network_tabs.PoolDetailsTabs
    template_name = 'network/loadbalancers/details_tabs.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        pool = self.get_data()
        context['pool'] = pool
        table = network_tables.PoolsTable(self.request)
...
class VipDetailsView(tabs.TabView):
    tab_group_class = network_tabs.VipDetailsTabs
    template_name = 'network/loadbalancers/details_tabs.html'


class MemberDetailsView(tabs.TabView):
    tab_group_class = network_tabs.MemberDetailsTabs
    template_name = 'network/loadbalancers/details_tabs.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        table = network_tables.MembersTable(self.request)
        context["url"] = self.get_redirect_url()
...
class MonitorDetailsView(tabs.TabView):
    tab_group_class = network_tabs.MonitorDetailsTabs
    template_name = 'network/loadbalancers/details_tabs.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        table = network_tables.MonitorsTable(self.request)
        context["url"] = self.get_redirect_url()
...
class UpdatePoolView(forms.ModalFormView):
    form_class = network_forms.UpdatePool
...
class UpdateVipView(forms.ModalFormView):
    form_class = network_forms.UpdateVip
...
class UpdateMemberView(forms.ModalFormView):
    form_class = network_forms.UpdateMember
    form_id = "update_pool_form"
...
class UpdateMonitorView(forms.ModalFormView):
    form_class = network_forms.UpdateMonitor
...
class AddPMAssociationView(workflows.WorkflowView):
    workflow_class = network_workflows.AddPMAssociation
...
class DeletePMAssociationView(workflows.WorkflowView):
    workflow_class = network_workflows.DeletePMAssociation

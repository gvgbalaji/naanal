...
INDEX_URL = "horizon:computes:instances:index"
ADD_USER_URL = "horizon:computes:instances:create_user"
...
class UpdateInstanceSecurityGroups(workflows.UpdateMembersStep):
    ...
    help_text = _("Add and remove security groups to this compute "

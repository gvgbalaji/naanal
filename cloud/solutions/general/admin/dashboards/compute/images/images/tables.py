...
class LaunchImageNG(LaunchImage):
    ...
    def get_link_url(self, datum):
        ...
        clickValue = "openLaunchInstanceWizard({successUrl: " +\
                     "'/compute/images/', imageId: '%s'})" % (imageId)
...
class CreateImage(tables.LinkAction):
    ...
    url = "horizon:compute:images:images:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditImage(tables.LinkAction):
    ...
    url = "horizon:compute:images:images:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class OwnerFilter(tables.FixedFilterAction):
    def get_fixed_buttons(self):
        ...
        buttons = [make_dict(_('Compute'), 'compute', 'fa-home')]
...
class ImagesTable(tables.DataTable):
    ...
    name = tables.Column(get_image_name,
                         link="horizon:compute:images:images:detail",

...
class OverviewUsageCsvRenderer(csvbase.BaseCsvResponse):
...
class OverviewSummary(usage.UsageView):
    table_class = usage.ProjectUsageTable
    usage_class = usage.ProjectUsage
    template_name = 'overview/summary/usage.html'
    csv_response_class = OverviewUsageCsvRenderer

    def get_data(self):
        super(OverviewSummary, self).get_data()
        return self.usage.get_instances()


class WarningView(views.HorizonTemplateView):
    template_name = "overview/_warning.html"

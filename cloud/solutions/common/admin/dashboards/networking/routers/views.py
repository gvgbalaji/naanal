...
from openstack_dashboard.dashboards.networking.routers\
    import forms as network_forms
from openstack_dashboard.dashboards.networking.routers import tables as rtables
from openstack_dashboard.dashboards.networking.routers import tabs as rdtabs


class IndexView(tables.DataTableView):
    table_class = rtables.RoutersTable
    template_name = 'networking/routers/index.html'
...
class DetailView(tabs.TabbedTableView):
    ...
    template_name = 'networking/routers/detail.html'
    failure_url = reverse_lazy('horizon:networking:routers:index')
...
class CreateView(forms.ModalFormView):
    form_class = network_forms.CreateForm
    form_id = "create_router_form"
    modal_header = _("Create Router")
    template_name = 'networking/routers/create.html'
    success_url = reverse_lazy("horizon:networking:routers:index")
    page_title = _("Create Router")
    submit_label = _("Create Router")
    submit_url = reverse_lazy("horizon:networking:routers:create")


class UpdateView(forms.ModalFormView):
    form_class = network_forms.UpdateForm
    form_id = "update_router_form"
    modal_header = _("Edit Router")
    template_name = 'networking/routers/update.html'
    success_url = reverse_lazy("horizon:networking:routers:index")
    page_title = _("Update Router")
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:routers:update"

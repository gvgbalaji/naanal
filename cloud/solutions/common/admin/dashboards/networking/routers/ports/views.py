...
from openstack_dashboard.dashboards.networking.routers.ports \
...
class AddInterfaceView(forms.ModalFormView):
    form_class = network_forms.AddInterface
    template_name = 'networking/routers/ports/create.html'
...
class SetGatewayView(forms.ModalFormView):
    form_class = network_forms.SetGatewayForm
    template_name = 'networking/routers/ports/setgateway.html'
    success_url = 'horizon:networking:routers:index'
    failure_url = 'horizon:networking:routers:index'
...
class DetailView(tabs.TabView):
    ...
    template_name = 'networking/basics/networks/ports/detail.html'

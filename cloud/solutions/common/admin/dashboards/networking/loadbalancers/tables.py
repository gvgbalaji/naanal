...
class AddPoolLink(tables.LinkAction):
    ...
    url = "horizon:network:loadbalancers:addpool"
    classes = ("ajax-modal",)
    icon = "plus"
...
class AddVipLink(tables.LinkAction):
    ...
    def get_link_url(self, pool):
        base_url = reverse("horizon:network:loadbalancers:addvip",
...
class AddMemberLink(tables.LinkAction):
    ...
    url = "horizon:network:loadbalancers:addmember"
    classes = ("ajax-modal",)
    icon = "plus"
...
class AddMonitorLink(tables.LinkAction):
    ...
    url = "horizon:network:loadbalancers:addmonitor"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdatePoolLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, pool):
        base_url = reverse("horizon:network:loadbalancers:updatepool",
                           kwargs={'pool_id': pool.id})
        return base_url
...
class UpdateVipLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, pool):
        base_url = reverse("horizon:network:loadbalancers:updatevip",
...
class UpdateMemberLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, member):
        base_url = reverse("horizon:network:loadbalancers:updatemember",
...
class UpdateMonitorLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    def get_link_url(self, monitor):
        base_url = reverse("horizon:network:loadbalancers:updatemonitor",
...
def get_vip_link(pool):
    if pool.vip_id:
        return reverse("horizon:network:loadbalancers:vipdetails",
...
class AddPMAssociationLink(policy.PolicyTargetMixin,
    ...
    url = "horizon:network:loadbalancers:addassociation"
    classes = ("ajax-modal",)
    icon = "plus"
...
class DeletePMAssociationLink(policy.PolicyTargetMixin,
    ...
    url = "horizon:network:loadbalancers:deleteassociation"
...
def get_pool_link(member):
    return reverse("horizon:network:loadbalancers:pooldetails",
                   args=(http.urlquote(member.pool_id),))


def get_member_link(member):
    return reverse("horizon:network:loadbalancers:memberdetails",
...
class MonitorsTable(tables.DataTable):
    monitor_type = tables.Column(
        ...
        link="horizon:network:loadbalancers:monitordetails")

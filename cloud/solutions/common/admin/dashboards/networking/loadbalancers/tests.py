...
from openstack_dashboard.dashboards.network.loadbalancers import workflows
...
class LoadBalancerTests(test.TestCase):
    ...
    def test_update_pool_get(self):
        ...
        self.assertTemplateUsed(res, 'network/loadbalancers/updatepool.html')
    ...
    def test_update_vip_get(self):
        ...
        self.assertTemplateUsed(res, 'network/loadbalancers/updatevip.html')
    ...
    def test_update_member_get(self):
        ...
        self.assertTemplateUsed(res, 'network/loadbalancers/updatemember.html')
    ...
    def test_update_monitor_get(self):
        ...
        self.assertTemplateUsed(
            res, 'network/loadbalancers/updatemonitor.html')

...
from openstack_dashboard.dashboards.network.vpn import workflows
...
class VPNTests(test.TestCase):
    ...
    def test_update_vpnservice_get(self):
        ...
        self.assertTemplateUsed(
            res, 'network/vpn/update_vpnservice.html')
    ...
    def test_update_ikepolicy_get(self):
        ...
        self.assertTemplateUsed(
            res, 'network/vpn/update_ikepolicy.html')
    ...
    def test_update_ipsecpolicy_get(self):
        ...
        self.assertTemplateUsed(
            res, 'network/vpn/update_ipsecpolicy.html')
    ...
    def test_update_ipsecsiteconnection_get(self):
        ...
        self.assertTemplateUsed(
            res, 'network/vpn/update_ipsecsiteconnection.html')

...
from openstack_dashboard.dashboards.networking.basics.\
    security_groups import forms as network_forms
from openstack_dashboard.dashboards.networking.basics.\
    security_groups import tables as network_tables


class DetailView(tables.DataTableView):
    table_class = network_tables.RulesTable
    template_name = 'networking/basics/security_groups/detail.html'
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:networking:basics:index')
...
class UpdateView(forms.ModalFormView):
    form_class = network_forms.UpdateGroup
    form_id = "update_security_group_form"
    modal_header = _("Edit Security Group")
    modal_id = "update_security_group_modal"
    template_name = 'networking/basics/security_groups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:networking:basics:security_groups:update"
    success_url = reverse_lazy('horizon:networking:basics:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('horizon:networking:basics:index')
...
class AddRuleView(forms.ModalFormView):
    form_class = network_forms.AddRule
    form_id = "create_security_group_rule_form"
    modal_header = _("Add Rule")
    modal_id = "create_security_group_rule_modal"
    template_name = 'networking/basics/security_groups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:networking:basics:security_groups:add_rule"
    page_title = _("Add Rule")

    def get_success_url(self):
        sg_id = self.kwargs['security_group_id']
        return reverse("horizon:networking:basics:"

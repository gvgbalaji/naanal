...
class DeleteGroup(policy.PolicyTargetMixin, tables.DeleteAction):
    ...
    def allowed(self, request, security_group=None):
        ...
        if api.base.is_service_enabled(request, "network"):
            ...
            policy = (("network", "network_extension:security_groups"),)
...
class CreateGroup(tables.LinkAction):
    ...
    url = "horizon:networking:basics:security_groups:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditGroup(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:networking:basics:security_groups:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class ManageRules(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:networking:basics:security_groups:detail"
    icon = "pencil"
...
class CreateRule(tables.LinkAction):
    ...
    url = "horizon:networking:basics:security_groups:add_rule"
    classes = ("ajax-modal",)
    icon = "plus"

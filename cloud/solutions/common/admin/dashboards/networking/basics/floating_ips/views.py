...
from openstack_dashboard.dashboards.networking.basics.\
    floating_ips import forms as network_forms
from openstack_dashboard.dashboards.networking.basics.\
    floating_ips import workflows as network_workflows


class AssociateView(workflows.WorkflowView):
    workflow_class = network_workflows.IPAssociationWorkflow


class AllocateView(forms.ModalFormView):
    form_class = network_forms.FloatingIpAllocate
    form_id = "associate_floating_ip_form"
    modal_header = _("Allocate Floating IP")
    template_name = 'networking/basics/floating_ips/allocate.html'
    submit_label = _("Allocate IP")
    submit_url = reverse_lazy(
        "horizon:networking:basics:floating_ips:allocate")

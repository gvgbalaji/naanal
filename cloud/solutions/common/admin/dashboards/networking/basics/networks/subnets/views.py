...
from openstack_dashboard.dashboards.networking.basics.networks.subnets import utils
from openstack_dashboard.dashboards.networking.basics.networks.subnets \
    import workflows as network_workflows


class CreateView(workflows.WorkflowView):
    workflow_class = network_workflows.CreateSubnet
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse('horizon:networking:basics:networks:index')
...
class UpdateView(workflows.WorkflowView):
    workflow_class = network_workflows.UpdateSubnet
...
class DetailView(tabs.TabView):
    tab_group_class = network_tabs.SubnetDetailTabs
    template_name = 'networking/basics/networks/subnets/detail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        table = network_tables.SubnetsTable(self.request,

...
STATE_DICT = dict(network_tables.DISPLAY_CHOICES)
STATUS_DICT = dict(network_tables.STATUS_DISPLAY_CHOICES)


class DetailView(tabs.TabView):
    tab_group_class = network_tabs.PortDetailTabs
    template_name = 'network/networks/ports/detail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        port = self.get_data()
        table = network_tables.PortsTable(self.request,
    ...
    def get_redirect_url():
        return reverse('horizon:networking:basics:networks:index')


class UpdateView(forms.ModalFormView):
    form_class = network_forms.UpdatePort
    form_id = "update_port_form"
    modal_header = _("Edit Port")
    template_name = 'networking/basics/networks/ports/update.html'
    context_object_name = 'port'
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:basics:networks:editport"
    success_url = 'horizon:networking:basics:networks:detail'

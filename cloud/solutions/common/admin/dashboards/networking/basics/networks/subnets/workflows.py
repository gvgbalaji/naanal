...
from openstack_dashboard.dashboards.networking.basics.networks import workflows \
...
class CreateSubnet(network_workflows.CreateNetwork):
    ...
    def get_success_url(self):
        return reverse("horizon:network:networks:detail",
...
class UpdateSubnet(network_workflows.CreateNetwork):
    ...
    success_url = "horizon:network:networks:detail"
    failure_url = "horizon:network:networks:detail"

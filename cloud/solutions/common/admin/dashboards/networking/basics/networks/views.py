...
from openstack_dashboard.dashboards.networking.basics.networks \
    import forms as network_forms
from openstack_dashboard.dashboards.networking.basics.networks.ports \
    import tables as port_tables
from openstack_dashboard.dashboards.networking.basics.networks.subnets \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'networking/basics/networks/index.html'
...
class CreateView(workflows.WorkflowView):
    workflow_class = network_workflows.CreateNetwork
    ajax_template_name = 'networking/basics/networks/create.html'


class UpdateView(forms.ModalFormView):
    context_object_name = 'network'
    form_class = network_forms.UpdateNetwork
    form_id = "update_network_form"
    modal_header = _("Edit Network")
    submit_label = _("Save Changes")
    submit_url = "horizon:networking:basics:networks:update"
    success_url = reverse_lazy("horizon:networking:basics:networks:index")
    template_name = 'networking/basics/networks/update.html'
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'networking/basics/networks/detail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        table = network_tables.NetworksTable(self.request)
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:networking:basics:networks:index')

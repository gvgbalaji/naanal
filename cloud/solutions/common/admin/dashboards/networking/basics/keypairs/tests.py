...
INDEX_VIEW_URL = reverse('horizon:networking.basics:index')
...
class KeyPairViewTests(test.TestCase):
    ...
    def test_create_keypair_get(self):
        res = self.client.get(
            reverse('horizon:networking.basics:keypairs:create'))
        self.assertTemplateUsed(
            res, 'networking.basics/keypairs/create.html')

    def test_download_keypair_get(self):
        keypair_name = "keypair"
        context = {'keypair_name': keypair_name}
        url = reverse('horizon:networking.basics:keypairs:download',
                      kwargs={'keypair_name': keypair_name})
        res = self.client.get(url, context)
        self.assertTemplateUsed(
            res, 'networking.basics/keypairs/download.html')
    ...
    def test_generate_keypair_get(self):
        ...
        url = reverse('horizon:networking.basics:keypairs:generate',
    ...
    def test_keypair_detail_get(self):
        ...
        context = {'keypair_name': keypair.name}
        url = reverse('horizon:networking.basics:keypairs:detail',
                      kwargs={'keypair_name': keypair.name})
        res = self.client.get(url, context)
    ...
    def test_import_keypair(self):
        ...
        url = reverse('horizon:networking.basics:keypairs:import')
    ...
    def test_generate_keypair_exception(self):
        ...
        self.assertRedirectsNoFollow(
            res, reverse('horizon:networking.basics:index'))

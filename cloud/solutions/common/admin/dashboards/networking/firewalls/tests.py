...
class FirewallTests(test.TestCase):
    ...
    def test_update_rule_get(self):
        ...
        self.assertTemplateUsed(res, 'network/firewalls/updaterule.html')
    ...
    def test_update_policy_get(self):
        ...
        self.assertTemplateUsed(res, 'network/firewalls/updatepolicy.html')
    ...
    def test_update_firewall_get(self):
        ...
        self.assertTemplateUsed(res, 'network/firewalls/updatefirewall.html')

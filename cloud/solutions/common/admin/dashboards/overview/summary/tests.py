...
INDEX_URL = reverse('horizon:overview:summary:index')
...
class UsageViewTests(test.TestCase):
    ...
    def _test_usage(self, nova_stu_enabled):
        ...
        res = self.client.get(reverse('horizon:overview:summary:index'))
        usages = res.context['usage']
        self.assertTemplateUsed(res, 'overview/summary/usage.html')
        self.assertTrue(isinstance(usages, usage.OverviewUsage))
    ...
    def test_unauthorized(self):
        ...
        url = reverse('horizon:overview:summary:index')
    ...
    def _test_usage_csv(self, nova_stu_enabled=True):
        ...
        res = self.client.get(reverse('horizon:overview:summary:index') +
                              "?format=csv")
        self.assertTemplateUsed(res, 'overview/summary/usage.csv')
        self.assertTrue(isinstance(res.context['usage'], usage.OverviewUsage))

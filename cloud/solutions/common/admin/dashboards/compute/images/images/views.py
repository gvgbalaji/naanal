...
from openstack_dashboard.dashboards.compute.images.images \
...
class CreateView(forms.ModalFormView):
    form_class = compute_forms.CreateImageForm
    template_name = 'compute/images/images/create.html'
...
class UpdateView(forms.ModalFormView):
    form_class = compute_forms.UpdateImageForm
    template_name = 'compute/images/images/update.html'
    success_url = reverse_lazy("horizon:compute:images:index")
...
class DetailView(tabs.TabView):
    tab_group_class = compute_tabs.ImageDetailTabs
    template_name = 'compute/images/images/detail.html'
    page_title = _("Image Details: {{ image.name }}")

    def get_context_data(self, **kwargs):
        context = super(DetailView, self).get_context_data(**kwargs)
        image = self.get_data()
        table = compute_tables.ImagesTable(self.request)
        context["image"] = image
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:compute:images:index')

...
from openstack_dashboard.dashboards.compute.containers \
    import browsers as compute_browsers
from openstack_dashboard.dashboards.compute.containers \
...
class ContainerView(browsers.ResourceBrowserView):
    browser_class = compute_browsers.ContainerBrowser
    template_name = "compute/containers/index.html"
...
class CreateView(forms.ModalFormView):
    form_class = compute_forms.CreateContainer
    template_name = 'compute/containers/create.html'
    success_url = "horizon:compute:containers:index"
...
class CreatePseudoFolderView(forms.ModalFormView):
    form_class = compute_forms.CreatePseudoFolder
    template_name = 'compute/containers/create_pseudo_folder.html'
    success_url = "horizon:compute:containers:index"
...
class UploadView(forms.ModalFormView):
    form_class = compute_forms.UploadObject
    template_name = 'compute/containers/upload.html'
    success_url = "horizon:compute:containers:index"
...
def object_download(request, container_name, object_path):
    try:
        ...
        redirect = reverse("horizon:compute:containers:index")
...
class CopyView(forms.ModalFormView):
    form_class = compute_forms.CopyObject
    template_name = 'compute/containers/copy.html'
    success_url = "horizon:compute:containers:index"
...
class ContainerDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'compute/containers/container_detail.html'
...
class ObjectDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'compute/containers/object_detail.html'
...
class UpdateObjectView(forms.ModalFormView):
    form_class = compute_forms.UpdateObject
    template_name = 'compute/containers/update.html'
    success_url = "horizon:compute:containers:index"

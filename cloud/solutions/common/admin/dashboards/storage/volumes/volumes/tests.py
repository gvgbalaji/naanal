...
VOLUME_INDEX_URL = reverse('horizon:storage:volumes:index')
VOLUME_VOLUMES_TAB_URL = reverse('horizon:storage:volumes:volumes_tab')
...
class VolumeViewTests(test.TestCase):
    ...
    def test_create_volume(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:create')
    ...
    def test_edit_attachments(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:attach',
                      args=[volume.id])
    ...
    def test_create_button_disabled_when_quota_exceeded(self):
        ...
        self.assertTemplateUsed(res, 'storage/volumes/index.html')
        ...
        expected_string = "<a href='%s' title='%s'  class='%s disabled' "\
            ...
            "'/storage/volumes/?action=create&amp;table=volumes'> "\
    ...
    def test_detail_view(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:detail',
                      args=[volume.id])
        res = self.client.get(url)
        ...
        self.assertContains(res,
                            ("<a href=\"/storage/instances/1/\">%s</a>"
                             % server.name),
                            1,
                            200)
    ...
    def test_encryption_detail_view_encrypted(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:encryption_detail',
                      args=[volume.id])
        res = self.client.get(url)
    ...
    def test_update_volume(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:update',
                      args=[volume.id])
        res = self.client.post(url, formData)
        self.assertRedirectsNoFollow(res, VOLUME_INDEX_URL)
    ...
    def test_upload_to_image(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:upload_to_image',
                      args=[volume.id])
    ...
    def test_extend_volume(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:extend',
                      args=[volume.id])
        res = self.client.post(url, formData)
    ...
    def test_retype_volume(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:retype',
                      args=[volume.id])
        res = self.client.post(url, form_data)
    ...
    def test_create_transfer(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:create_transfer',
    ...
    def test_accept_transfer(self):
        ...
        url = reverse('horizon:storage:volumes:volumes:accept_transfer')
        res = self.client.post(url, formData, follow=True)
        self.assertNoFormErrors(res)

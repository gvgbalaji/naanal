...
from openstack_dashboard.dashboards.storage.volumes.snapshots \
    import urls as snapshot_urls
from openstack_dashboard.dashboards.storage.volumes import views
from openstack_dashboard.dashboards.storage.volumes.volumes \

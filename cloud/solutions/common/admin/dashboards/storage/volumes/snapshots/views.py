...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'storage/volumes/snapshots/update.html'
    submit_label = _("Save Changes")
    submit_url = "horizon:storage:volumes:snapshots:update"
...
class DetailView(tabs.TabView):
    ...
    template_name = 'storage/volumes/snapshots/detail.html'

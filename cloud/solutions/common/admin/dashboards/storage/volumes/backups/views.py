...
from openstack_dashboard.dashboards.storage.volumes.backups \
...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'storage/volumes/backups/create_backup.html'
    submit_label = _("Create Volume Backup")
    submit_url = "horizon:storage:volumes:volumes:create_backup"
    success_url = reverse_lazy("horizon:storage:volumes:backups_tab")
...
class BackupDetailView(tabs.TabView):
    ...
    template_name = 'storage/volumes/backups/detail.html'
...
class RestoreBackupView(forms.ModalFormView):
    ...
    template_name = 'storage/volumes/backups/restore_backup.html'

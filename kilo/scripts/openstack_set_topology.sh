...
source /opt/naanal/kilo/env/setuprc
/opt/naanal/kilo/scripts/openstack_reset_topology.sh
...
neutron net-create wan-net --provider:network_type flat --provider:physical_network wan-phy-net --shared --router
